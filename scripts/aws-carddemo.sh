...
for str in ${myArray[@]}; do
    source config-local/local.env.sh && java -jar smojol-cli/target/smojol-cli.jar run $str --commands="EXPORT_TO_GRAPHML WRITE_FLOW_AST WRITE_CFG WRITE_DATA_STRUCTURES EXPORT_UNIFIED_TO_JSON INJECT_INTO_NEO4J BUILD_PROGRAM_DEPENDENCIES" --srcDir /Users/asgupta/code/aws-mainframe-modernization-carddemo/app/cbl --copyBooksDir "/Users/asgupta/code/aws-mainframe-modernization-carddemo/app/cpy,/Users/asgupta/code/aws-mainframe-modernization-carddemo/app/cpy-bms" --dialectJarPath che-che4z-lsp-for-cobol-integration/server/dialect-idms/target/dialect-idms.jar --dialect COBOL --reportDir out --generation=PARAGRAPH
