...
public class SectionQuadGeneration extends QuadGeneration {
    public SectionQuadGeneration(PseudocodeGraph graph, SmojolSymbolTable symbolTable, SymbolReferenceBuilder symbolReferenceBuilder) {
