...
public class Neo4JASTBuilderVisitor extends FlowNodeASTVisitor<Record> {
  ...
  public Neo4JASTBuilderVisitor(
      NodeReferenceStrategy astNodeReferenceStrategy,
      GraphSDK graphSDK,
  ...
  public Neo4JASTBuilderVisitor(
      NodeReferenceStrategy astNodeReferenceStrategy, GraphSDK sdk, NodeSpecBuilder qualifier) {
