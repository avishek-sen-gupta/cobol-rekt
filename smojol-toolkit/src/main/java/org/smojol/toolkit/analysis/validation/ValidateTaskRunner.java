...
public class ValidateTaskRunner {
  ...
  public boolean processPrograms(
  ...
  public boolean processPrograms(
      ...
      String dialectJarPath,
      String outputPath,
      Function<ProgramValidationErrors, Boolean> successCriterion,
      DataStructureValidation dataStructureValidation) {
    String absoluteDialectJarPath =
        Paths.get(dialectJarPath).toAbsolutePath().normalize().toString();
    List<ProgramValidationErrors> validationErrors =
        programNames.stream()
            .map(
                p ->
                    run(
                        copyBookPaths,
                        absoluteDialectJarPath,
                        p,
                        sourceDir,
                        dialect,
  ...
  public ProgramValidationErrors run(
      List<File> copyBookPaths,
      String absoluteDialectJarPath,
    ...
    SourceConfig sourceConfig =
        new SourceConfig(
            programFilename, programPath.getRight(), copyBookPaths, absoluteDialectJarPath);
