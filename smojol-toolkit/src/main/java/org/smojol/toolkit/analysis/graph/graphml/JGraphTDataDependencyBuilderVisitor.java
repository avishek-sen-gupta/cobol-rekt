...
public class JGraphTDataDependencyBuilderVisitor extends FlowNodeASTVisitor<CobolDataStructure> {
  ...
  public JGraphTDataDependencyBuilderVisitor(
      JGraphTDataOperations jGraphTDataOperations, CobolDataStructure dataRoot) {
    this(jGraphTDataOperations, dataRoot, null);
  }

  public JGraphTDataDependencyBuilderVisitor(
      JGraphTDataOperations jGraphTDataOperations,
      CobolDataStructure dataRoot,
      CobolDataStructure ancestor) {
    super(ancestor);
  ...
  public CobolDataStructure visit(FlowNode node) {
    Pair<List<CobolDataStructure>, List<CobolDataStructure>> pairs =
  ...
  private void connect(
      List<CobolDataStructure> froms, List<CobolDataStructure> tos, FlowNode node) {
    tos.forEach(
        to -> {
