...
public class UnifiedFlowModelTask {
  ...
  public UnifiedFlowModelTask(
      FlowNode flowRoot, CobolDataStructure dataStructures, NodeSpecBuilder qualifier) {
  ...
  public SerialisableUnifiedModel run() {
    JGraphTGraphBuilder graphMLExporter =
        new JGraphTGraphBuilder(dataStructures, flowRoot, qualifier);
