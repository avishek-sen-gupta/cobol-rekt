...
public class ParsePipeline {
  ...
  public CobolEntityNavigator parse(DataStructureValidation dataStructureValidation)
            ...
            .addSerializationExclusionStrategy(
                new ExclusionStrategy() {
                  ...
                  public boolean shouldSkipField(FieldAttributes fieldAttributes) {
                    return "recognizer".equals(fieldAttributes.getName())
    ...
    StageResult<ParserStageResult> lastStageResult =
        (StageResult<ParserStageResult>) pipelineResult.getLastStageResult();
    ...
    if (!ctx.getAccumulatedErrors().isEmpty()) {
      ...
      throw new ParseDiagnosticRuntimeError(
          "There were parsing errors!", ctx.getAccumulatedErrors());
    }
