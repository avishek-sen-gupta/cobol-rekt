...
public class CobolProgramDependencyNeo4JVisitor implements ProgramVisitor {
  ...
  public CobolProgramDependencyNeo4JVisitor(
      CobolProgram root, NodeSpecBuilder qualifier, GraphSDK graphSDK) {
    this(root, null, qualifier, graphSDK);
  }

  public CobolProgramDependencyNeo4JVisitor(
      CobolProgram root, Record neo4jRoot, NodeSpecBuilder qualifier, GraphSDK graphSDK) {
