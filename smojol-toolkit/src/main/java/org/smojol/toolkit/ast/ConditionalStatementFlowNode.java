...
public class ConditionalStatementFlowNode extends CobolFlowNode {
  ...
  public ConditionalStatementFlowNode(
  ...
  public void buildInternalFlow() {
    CobolParser.ConditionalStatementCallContext stmt =
        (CobolParser.ConditionalStatementCallContext) executionContext;
    if (stmt.statement() != null)
      actualStatement = nodeService.node(stmt.statement(), this, staticFrameContext);
    else actualStatement = nodeService.node(stmt.dialectStatement(), this, staticFrameContext);
