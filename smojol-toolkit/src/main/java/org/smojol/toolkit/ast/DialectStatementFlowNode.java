...
public class DialectStatementFlowNode extends CobolFlowNode {
  ...
  public DialectStatementFlowNode(
  ...
  public void buildInternalFlow() {
    ...
    DialectContainerNode containerNode =
        (DialectContainerNode)
            navigator.findByCondition(n -> n.getClass() == DialectContainerNode.class);
    LocalisedDialect dialect = containerNode.getDialect();
    switch (dialect) {
      case IDMS:
        buildIdmsFlow(navigator);
        break;
      case CICS:
        buildCicsFLow(containerNode);
        break;
      case DB2_SQL:
        buildDb2SqlFlow(containerNode);
    }
  }
  ...
  private void buildIdmsFlow(CobolEntityNavigator navigator) {
    ...
    ParseTree possibleDbAccessStatement =
        navigator.findByCondition(
            containerChild,
            n ->
                n.getClass() == IdmsParser.ObtainStatementContext.class
    ...
    if (navigator.findByCondition(
            containerChild, n -> n.getClass() == IdmsParser.TransferStatementContext.class)
        != null) {
      dialectChildNode =
          new IdmsTransferFlowNode(containerChild, this, nodeService, staticFrameContext);
      ...
      dialectChildNode =
          nodeService.node(
              navigator.findByCondition(
                  executionContext, n -> n.getClass() == IdmsParser.IdmsStatementsContext.class),
              this,
              staticFrameContext);
