...
public class ComputeFlowNode extends CobolFlowNode {
  ...
  public void buildInternalFlow() {
    CobolParser.ComputeStatementContext computeStatement =
        new SyntaxIdentity<CobolParser.ComputeStatementContext>(executionContext).get();
  ...
  public void resolve(SmojolSymbolTable symbolTable, CobolDataStructure dataStructures) {
    ...
    destinationExpressions =
        destinations.stream().map(dest -> builder.identifier(dest.generalIdentifier())).toList();
  }
}
