...
public class GenericOnClauseFlowNode extends CobolFlowNode {
  ...
  public GenericOnClauseFlowNode(
  ...
  public void buildInternalFlow() {
    CobolParser.GenericOnClauseStatementContext onClause =
        new SyntaxIdentity<CobolParser.GenericOnClauseStatementContext>(executionContext).get();
    condition = nodeService.node(onClause.generalIdentifier(), this, staticFrameContext);
    onClauseBlock =
        new OnClauseActionsFlowNode(
            onClause.onClauseBlock(), this, nodeService, staticFrameContext);
