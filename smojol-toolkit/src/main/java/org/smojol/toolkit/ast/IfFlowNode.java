...
public class IfFlowNode extends CobolFlowNode {
  ...
  public void buildInternalFlow() {
    CobolParser.IfStatementContext ifStatement =
        new SyntaxIdentity<CobolParser.IfStatementContext>(getExecutionContext()).get();
    condition = (CobolParser.ConditionContext) ifStatement.getChild(1);
    FlowNode ifThenBlock =
        nodeService.node(ifStatement.ifThen(), this, staticFrameContext.add(this));
