...
public class IdmsTransferFlowNode extends CobolFlowNode implements ExternalControlFlowNode {
  ...
  public void buildInternalFlow() {
    ...
    IdmsParser.TransferStatementContext transfer =
        (IdmsParser.TransferStatementContext)
            navigator.findByCondition(
                getExecutionContext(),
                n -> n.getClass() == IdmsParser.TransferStatementContext.class);
