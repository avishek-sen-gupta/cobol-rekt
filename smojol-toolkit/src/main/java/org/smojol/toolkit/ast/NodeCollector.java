...
public class NodeCollector implements ParseTreeVisitor<List<FlowNode>> {
  ...
  public List<FlowNode> visit(ParseTree parseTree) {
    if (parseTree.getClass() == CobolParser.EndClauseContext.class
        || parseTree.getClass() == IdmsParser.EndClauseContext.class) return collectedNodes;
  ...
  public List<FlowNode> visitChildren(RuleNode ruleNode) {
    if (ruleNode.getClass() == CobolParser.EndClauseContext.class
        || ruleNode.getClass() == IdmsParser.EndClauseContext.class) return collectedNodes;
