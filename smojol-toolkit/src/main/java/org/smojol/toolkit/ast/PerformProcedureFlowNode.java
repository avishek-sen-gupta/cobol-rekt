...
public class PerformProcedureFlowNode extends CobolFlowNode implements InternalControlFlowNode {
  ...
  public PerformProcedureFlowNode(
  ...
  public void buildInternalFlow() {
    CobolParser.PerformStatementContext performStatement =
        new SyntaxIdentity<CobolParser.PerformStatementContext>(getExecutionContext()).get();
    CobolParser.PerformProcedureStatementContext performProcedureStatementContext =
        performStatement.performProcedureStatement();
    if (isVarying()) {
      condition =
          nodeService.node(
              performProcedureStatementContext.performType(), this, staticFrameContext);
    }

    if (performProcedureStatementContext != null) return;
    inlineStatementContext =
        nodeService.node(performStatement.performInlineStatement(), this, staticFrameContext);
  ...
  private boolean isVarying() {
    ...
    CobolParser.PerformProcedureStatementContext performProcedureStatementContext =
        performStatement.performProcedureStatement();
    return performProcedureStatementContext.performType() != null
        && performProcedureStatementContext.performType().performVarying() != null;
  }
  ...
  public void buildControlFlow() {
    ...
    CobolParser.ProcedureNameContext procedureNameContext =
        performProcedureStatementContext.procedureName();
    ...
    if (performStatement.performProcedureStatement().through() == null) {
      ...
      CobolParser.ProcedureNameContext endProcedureNameContext =
          performStatement.performProcedureStatement().through().procedureName();
  ...
  public void acceptUnvisited(FlowNodeVisitor visitor, int level) {
    ...
    if (inlineStatementContext != null) {
      visitor.visitParentChildLink(
          this, inlineStatementContext, new VisitContext(level), nodeService);
  ...
  public CobolVmSignal acceptInterpreter(CobolInterpreter interpreter, FlowControl flowControl) {
    CobolVmSignal signal =
        interpreter.scope(this).executePerformProcedure(this, procedures, nodeService);
  ...
  public List<FlowNode> astChildren() {
    return inlineStatementContext != null
        ? ImmutableList.of(inlineStatementContext)
        : ImmutableList.of();
  }
  ...
  public void resolve(SmojolSymbolTable symbolTable, CobolDataStructure dataStructures) {
    ...
    CobolParser.PerformProcedureStatementContext performProcedureStatementContext =
        performStatement.performProcedureStatement();
    nestedLoops =
        performProcedureStatementContext.performType() != null
            ? FlowIterationBuilder.build(
                performProcedureStatementContext.performType(), dataStructures)
            : ImmutableList.of();
  }
}
