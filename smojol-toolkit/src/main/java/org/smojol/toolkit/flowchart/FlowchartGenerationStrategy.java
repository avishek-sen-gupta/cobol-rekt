...
public abstract class FlowchartGenerationStrategy {
  ...
  public static final FlowchartGenerationStrategy DONT_DRAW =
      new FlowchartGenerationStrategy(null) {
        @Override
        public void draw(
  ...
  public static FlowchartGenerationStrategy strategy(
      String generationStrategyAsString, String flowchartOutputFormatAsString) {
    FlowchartOutputFormat flowchartOutputFormat =
        "PNG".equals(flowchartOutputFormatAsString) ? PNG : SVG;
  ...
  static String outputPath(
      CobolParser.SectionOrParagraphContext section, Path outputDir, String extension) {
    String sectionName = new SectionNameExtractor().sectionName(section);
    return outputPath(sectionName, outputDir, extension);
  }

  static String outputPath(
      CobolParser.ParagraphContext paragraph, Path outputDir, String extension) {
