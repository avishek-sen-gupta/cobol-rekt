...
public class CobolInterpreterFactory {
  public static CobolInterpreter executingInterpreter(
    ...
    return interpreter(
        ...
        listeners,
        bp,
        new CobolStackFrames(dataStructures),
        RealOperations.OPS);
  }

  public static CobolInterpreter nonExecutingInterpreter(
      ConditionResolver conditionResolver,
      CobolDataStructure dataStructures,
      List<ExecutionInterceptor> interceptors,
      ExecutionListener listeners,
  ...
  public static CobolInterpreter interpreter(
    ...
    return new SmojolInterpreter(
        runtimeStackFrames, condition, conditionResolver, bp, interceptors, listeners, operations);
  }
}
