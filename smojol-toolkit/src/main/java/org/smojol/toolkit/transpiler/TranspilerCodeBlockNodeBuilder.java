...
public class TranspilerCodeBlockNodeBuilder {
  ...
  private static TranspilerCodeBlockNode block(
      FlowNode n,
      CobolDataStructure dataStructures,
      Map<String, Object> additionalAttributes,
      SectionParagraphMap sectionParagraphMap) {
    List<TranspilerNode> childTranspilerNodes =
  ...
  private static TranspilerCodeBlockNode block(
      FlowNode n, CobolDataStructure dataStructures, SectionParagraphMap sectionParagraphMap) {
    return block(n, dataStructures, ImmutableMap.of(), sectionParagraphMap);
  }

  public static TranspilerNode build(
      ParagraphsFlowNode n,
      CobolDataStructure dataStructures,
      SectionParagraphMap sectionParagraphMap) {
    return block(n, dataStructures, sectionParagraphMap);
  }
  ...
  public static TranspilerNode build(
      ...
      SectionParagraphMap sectionParagraphMap) {
    return block(
        n, dataStructures, ImmutableMap.of("type", FlowNodeType.SENTENCE), sectionParagraphMap);
  }
}
