...
public class TranspilerTreeBuilder {
  public static TranspilerNode flowToTranspiler(
    ...
    return switch (node) {
      ...
      case SearchFlowNode n ->
          SearchWhenNodeTranslator.build(n, dataStructures, sectionParagraphMap);
      case EvaluateFlowNode n ->
          EvaluateNodeTranslator.build(n, dataStructures, sectionParagraphMap);
      ...
      case ConditionalStatementFlowNode n ->
          flowToTranspiler(n.getActualStatement(), dataStructures, sectionParagraphMap);
      case ProcedureDivisionBodyFlowNode n ->
          LabelledTranspilerCodeBlockNodeBuilder.build(n, dataStructures, sectionParagraphMap);
      case SectionFlowNode n ->
          LabelledTranspilerCodeBlockNodeBuilder.build(n, dataStructures, sectionParagraphMap);
      case ParagraphsFlowNode n ->
          TranspilerCodeBlockNodeBuilder.build(n, dataStructures, sectionParagraphMap);
      case SentenceFlowNode n ->
          TranspilerCodeBlockNodeBuilder.build(n, dataStructures, sectionParagraphMap);
      case ParagraphFlowNode n ->
          LabelledTranspilerCodeBlockNodeBuilder.build(n, dataStructures, sectionParagraphMap);
      ...
      case PerformInlineFlowNode n ->
          PerformProcedureNodeBuilder.build(n, dataStructures, sectionParagraphMap);
