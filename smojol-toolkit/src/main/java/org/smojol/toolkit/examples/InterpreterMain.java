...
public class InterpreterMain {
  ...
  public static void main(String[] args) throws IOException {
    SourceConfig testSourceConfig =
        new SourceConfig(
            "interpreter-test.cbl",
            "/Users/asgupta/code/smojol/smojol-test-code",
            ImmutableList.of(new File("/Users/asgupta/code/smojol/smojol-test-code")),
            "/Users/asgupta/code/smojol/che-che4z-lsp-for-cobol-integration/server/dialect-idms/target/dialect-idms.jar");
    //        File source = new
    // File("/Users/asgupta/code/smojol/smojol-test-code/table-indexing.cbl");
    //        File source = new File("/Users/asgupta/code/smojol/smojol-test-code/table-redef.cbl");
    //        File source = new
    // File("/Users/asgupta/code/smojol/smojol-test-code/simple-redef.cbl");

    SourceConfig awsCardDemoConfig =
        new SourceConfig(
            "CBACT01C.cbl",
    ...
    AnalysisTaskResult result =
        new InterpretTask(
                ...
                CobolConditionResolver.ALWAYS_YES,
