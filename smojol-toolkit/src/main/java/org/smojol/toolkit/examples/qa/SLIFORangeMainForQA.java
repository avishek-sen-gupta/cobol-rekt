...
public class SLIFORangeMainForQA {
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    Map<String, List<AnalysisTaskResult>> result =
        new CodeTaskRunner(
                "/Users/asgupta/code/qa-codebase/Missing Programs",
            ...
            .runForPrograms(
                ImmutableList.of(BUILD_BASE_ANALYSIS, BUILD_TRANSPILER_FLOWGRAPH),
    ...
    Pair<Set<InvokingProcedureRange>, Set<InvokingProcedureRange>> categorisedRanges =
        transpilerFlowgraph.categorisedRanges();
    ...
    System.out.println(
        "Total ranges = "
            + (categorisedRanges.getLeft().size() + categorisedRanges.getRight().size()));
