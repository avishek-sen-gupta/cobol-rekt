...
public class EvaluateBuildMain_Issue62 {
  public static void main(String[] args) throws IOException, InterruptedException {
    Map<String, List<AnalysisTaskResult>> result =
        new CodeTaskRunner(
                ...
                new FullProgram(FlowchartOutputFormat.PNG, new UUIDProvider()),
                new UUIDProvider(),
            ...
            .runForPrograms(
                ...
                ImmutableList.of("test-evaluate-without-through.cbl"));
    AnalysisTaskResultOK ok =
        (AnalysisTaskResultOK) result.values().stream().toList().getFirst().getFirst();
