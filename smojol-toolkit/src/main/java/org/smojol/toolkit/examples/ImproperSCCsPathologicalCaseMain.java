...
public class ImproperSCCsPathologicalCaseMain {
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    AnalysisTaskResult irreducibleRegionsResult =
        new IrreducibleStronglyConnectedComponentsTask<>(transpilerFlowgraph.instructionFlowgraph())
            .run();
    List<Pair<Graph<TranspilerInstruction, DefaultEdge>, Set<DefaultEdge>>> irreducibleRegions =
        ((AnalysisTaskResultOK) irreducibleRegionsResult).getDetail();
  }
}
