...
public class CobolDataStructureBuilderTest {
  ...
  public void canBuildDataStructures() throws IOException {
    ...
    root(
            ...
            table(
                "SOME-ARRAY", 3, string("SOME-ARRAY"), string("SOME-ARRAY"), string("SOME-ARRAY")),
            group(
                "SOME-PART",
                string("SOME-PART-1"),
                string("SOME-PART-2"),
            ...
            group(
                ...
                table(
                    ...
                    group(
                        "LEVEL-10-B",
                        table("LEVEL-20-B", 2, string("LEVEL-20-B"), string("LEVEL-20-B"))),
                    group(
                        "LEVEL-10-B",
                        table("LEVEL-20-B", 2, string("LEVEL-20-B"), string("LEVEL-20-B")))),
                group("AA", true, number("AA1"), number("AA2"))),
            string("SOMETHING"),
            table("SOMEFRACTION", 2, number("SOMEFRACTION"), number("SOMEFRACTION")),
            group("SOME-UNION-1", true, number("UNION-CHILD-1"), string("UNION-CHILD-2", true)),
            number("SOMETEXT"),
