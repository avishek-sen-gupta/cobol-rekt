...
/**
 * Builds minimal CobolDataStructure trees for testing. Same package as CobolDataStructure to
 * access the protected 'structures' field. Uses a minimal test stub that returns the name directly
 * (unlike NullDataStructure which wraps it in "NULL[...]").
 */
