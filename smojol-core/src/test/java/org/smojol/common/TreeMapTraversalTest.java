...
public class TreeMapTraversalTest {
  ...
  public void canMapTree() {
    ...
    SummarisedTestTreeNode mappedRoot =
        new TreeMapperTraversal<TestTreeNode, SummarisedTestTreeNode>()
            .accept(root, new NodeSummariser(), TestTreeNode::children);
...
class NodeSummariser extends TreeMapperVisitor<TestTreeNode, SummarisedTestTreeNode> {
  ...
  @Override
  public SummarisedTestTreeNode processChildResults(
      TestTreeNode node, List<SummarisedTestTreeNode> mappedChildren) {
...
record SummarisedTestTreeNode(String id, String summary, List<SummarisedTestTreeNode> children)
