...
import com.mojo.algorithms.task.NaturalLoopOfBackEdgeTask;
...
public class DepthFirstSearchOrderingTaskTest {
  ...
  public void canLabelDFSOrderForSimpleGraphWithNoLoops() {
    ...
    graph.addEdge(va, vb);
    graph.addEdge(va, vc);
    DepthFirstSearchOrderingTask<TestNode, DefaultEdge> task =
        new DepthFirstSearchOrderingTask<>(va, graph, DefaultEdge.class);
  ...
  public void canLabelTreeDepthForExampleDominatorTree() {
    ...
    DepthFirstSearchOrderingTask<TestNode, DefaultEdge> task =
        new DepthFirstSearchOrderingTask<>(vSTART, graph, DefaultEdge.class);
    DepthFirstSpanningTree<TestNode, DefaultEdge> spanningTree = task.run();
  ...
  public void canLabelDFSOrderForSimpleGraphWithBranches() {
    ...
    DepthFirstSearchOrderingTask<TestNode, DefaultEdge> task =
        new DepthFirstSearchOrderingTask<>(v0, graph, DefaultEdge.class);
    DepthFirstSpanningTree<TestNode, DefaultEdge> spanningTree = task.run();
    List<TestNode> ordered = spanningTree.preOrdered();
  ...
  */
  ...
  public void canLabelDFSOrderForSimpleGraphWithBackEdges() {
    ...
    DepthFirstSearchOrderingTask<TestNode, DefaultEdge> task =
        new DepthFirstSearchOrderingTask<>(v1, graph, 1, DefaultEdge.class);
    DepthFirstSpanningTree<TestNode, DefaultEdge> spanningTree = task.run();
  ...
  public void canClassifyEdges() {
    ...
    DepthFirstSearchOrderingTask<TestNode, DefaultEdge> task =
        new DepthFirstSearchOrderingTask<>(vS, graph, 1, DefaultEdge.class);
    DepthFirstSpanningTree<TestNode, DefaultEdge> spanningTree = task.run();
  ...
  public void doesNotLabelBackEdgesSpuriously() {
    ...
    DepthFirstSearchOrderingTask<TestNode, DefaultEdge> task =
        new DepthFirstSearchOrderingTask<>(v0, graph, 1, DefaultEdge.class);
    DepthFirstSpanningTree<TestNode, DefaultEdge> spanningTree = task.run();
