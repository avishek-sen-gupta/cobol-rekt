...
public class BuildSerialisableASTTask {
  ...
  private void buildContextGraph(
      ParseTree astParentNode,
      CobolContextAugmentedTreeNode graphParentNode,
    ...
    for (int i = 0; i <= astParentNode.getChildCount() - 1; ++i) {
      ...
      CobolContextAugmentedTreeNode graphChildNode =
          new CobolContextAugmentedTreeNode(astChildNode, navigator);
