...
public class ComponentsBuilder {
  ...
  public ComponentsBuilder(
      ...
      EntityNavigatorBuilder cobolEntityNavigatorBuilder,
  ...
  public CobolDataStructureBuilder getDataStructureBuilder(CobolEntityNavigator navigator) {
    return new CobolDataStructureBuilder(
        navigator, unresolvedReferenceStrategy, format1DataStructureBuilder, idProvider);
  }
}
