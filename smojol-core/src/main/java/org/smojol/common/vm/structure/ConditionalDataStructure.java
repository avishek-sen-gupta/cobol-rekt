...
public class ConditionalDataStructure extends CobolDataStructure {
  ...
  public ConditionalDataStructure(
      CobolParser.DataDescriptionEntryFormat3Context dataDescription,
      CobolDataStructure parent,
      SourceSection sourceSection) {
    super(
        dataDescription.getText(),
        88,
        parent.getDataType(),
  ...
  @Override
  public String name() {
    return dataDescription.entryName() != null
        ? dataDescription.entryName().getText()
        : "UNNAMED-88";
  }
  ...
  public MemoryLayout layout() {
    throw new UnsupportedOperationException(
        "Conditional variable cannot be queried for memory layout");
  }
  ...
  public CobolDataStructure addConditionalVariable(
    ...
    throw new UnsupportedOperationException(
        "Cannot add conditional variable to conditional variable");
  }
  ...
  public void calculateMemoryRequirements() {
    throw new UnsupportedOperationException(
        "Cannot calculate memory requirements for conditional variable");
  }
  ...
  public TypedRecord getValue() {
    ...
    for (CobolParser.DataValueClauseContext acceptedValue : permittedValues) {
      List<CobolParser.DataValueIntervalContext> intervals =
          acceptedValue.dataValueClauseLiteral().dataValueInterval();
      for (CobolParser.DataValueIntervalContext intervalContext : intervals) {
        ...
        if (parent.typed(resolve(intervalContext.dataValueIntervalFrom())).equals(actualValue))
          return TypedRecord.TRUE;
      }
    }
  ...
  private String resolve(CobolParser.DataValueIntervalFromContext dataValueIntervalFromContext) {
    ...
    TypedRecord data =
        ((PrimitiveCobolExpression) new LiteralResolver().literal(literal, dataType.abstractType()))
            .data();
  ...
  public List<CobolDataStructure> matches(String recordID) {
    ...
    return dataDescription.entryName().getText().equals(recordID)
