...
public class PrimitiveCobolExpression extends CobolExpression {
  ...
  private CobolExpression returnIf(
      Function<PrimitiveCobolExpression, CobolExpression> evaluation, CobolExpression other) {
    if (!isCompatibleWith(other)) throw new IncompatibleClassChangeError("Incompatible types");
