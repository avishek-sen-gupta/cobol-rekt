...
public interface CobolInterpreter {
  ...
  CobolVmSignal executeDisplay(
      FlowNode node, List<CobolParser.DisplayOperandContext> messages, FlowNodeService nodeService);
  ...
  CobolVmSignal executeSearch(
      FlowNode node,
      List<FlowNode> whenPhrases,
      FlowNodeService nodeService,
      FlowNode searchFlowNode);
