...
/**
 * This interface specifically allows execution to be restricted to a single para/section, or not.
 * This is so that PERFORM can return after that single para/section.
 */
