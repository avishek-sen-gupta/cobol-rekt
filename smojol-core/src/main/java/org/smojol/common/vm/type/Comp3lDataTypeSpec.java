...
public class Comp3lDataTypeSpec extends DataTypeSpec {
    ...
    public Comp3lDataTypeSpec(int leftSideDigits, int rightSideDigits, SignType signType) {
    ...
    public Object readPublic(MemoryAccess access) {
        return Double.parseDouble(numberAsString(access));
    }
    ...
    private String numberAsString(MemoryAccess access) {
        ...
        String numberStringWithoutSign = fullByteStringWithSign.substring(0, fullByteStringWithSign.length() - 1);
        return numberStringWithoutSign;
    }
