...
public abstract class CobolExpression {
  ...
  public CobolDataStructure reference(CobolDataStructure data) {
    throw new UnsupportedOperationException(
        "Cannot resolve to references of intermediate expressions");
  }
  ...
  public CobolExpression lessThanOrEqualTo(
    ...
    return evaluate(dataStructures)
        .lessThanOrEqualTo(other.evaluate(dataStructures), dataStructures);
  }

  public CobolExpression greaterThanOrEqualTo(
      CobolExpression other, CobolDataStructure dataStructures) {
    return evaluate(dataStructures)
        .greaterThanOrEqualTo(other.evaluate(dataStructures), dataStructures);
  }
