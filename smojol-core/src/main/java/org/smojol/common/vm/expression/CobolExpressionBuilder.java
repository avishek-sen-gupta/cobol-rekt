...
public class CobolExpressionBuilder {
  private static final java.util.logging.Logger LOGGER =
      Logger.getLogger(CobolExpressionBuilder.class.getName());
  ...
  public CobolExpression literalOrIdentifier(
      CobolParser.LiteralContext literalContext,
      CobolParser.GeneralIdentifierContext identifierContext) {
    return literalContext != null
        ? literal(literalContext, AbstractCobolType.NUMBER)
  ...
  public CobolExpression condition(
      CobolParser.ConditionContext condition, CobolDataStructure dataStructures) {
  ...
  public CobolExpression literalOrIdentifier(
      ...
      CobolParser.GeneralIdentifierContext identifierContext) {
    return integerLiteralContext != null
        ? literal(integerLiteralContext)
        : identifier(identifierContext);
  }
  ...
  public CobolExpression identifier(CobolParser.QualifiedDataNameContext context) {
    VariableExpression variableExpression =
        new VariableExpression(context.variableUsageName().getText());
    return context.tableCall() != null
        ? new TableCallExpression(
            variableExpression,
            context.tableCall().argument().stream()
                .map(CobolParser.ArgumentContext::arithmeticExpression)
                .toList())
        : variableExpression;
  }
}
