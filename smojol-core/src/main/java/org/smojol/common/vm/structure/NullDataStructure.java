...
public class NullDataStructure extends CobolDataStructure {
  private static final java.util.logging.Logger LOGGER =
      Logger.getLogger(NullDataStructure.class.getName());
  ...
  public TypedRecord getValue() {
    LOGGER.warning(
        ConsoleColors.red(
            "NULL value being accessed. This will be an empty string! Original reference ID: "
                + referenceID));
