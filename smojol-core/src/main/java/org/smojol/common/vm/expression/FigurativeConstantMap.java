...
public class FigurativeConstantMap {
  private static final java.util.logging.Logger LOGGER =
      Logger.getLogger(FigurativeConstantMap.class.getName());
  ...
  public String map(String figurativeConstant) {
    ...
    else if ("ZERO".equals(figurativeConstant)
        || "ZEROES".equals(figurativeConstant)
        || "ZEROS".equals(figurativeConstant)) return "0";
    ...
    throw new UnsupportedOperationException(
        "Unsupported figurative constant: " + figurativeConstant);
  }
}
