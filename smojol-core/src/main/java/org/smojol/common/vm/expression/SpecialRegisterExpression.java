...
public class SpecialRegisterExpression extends CobolExpression {
  ...
  public SpecialRegisterExpression(CobolParser.SpecialRegisterContext specialRegisterContext) {
    ...
    CobolExpression argument =
        new CobolExpressionBuilder().identifier(specialRegisterContext.generalIdentifier());
    functionCall =
        new FunctionCallExpression(
            specialRegisterContext.ADDRESS() != null ? "ADDRESS" : "LENGTH",
