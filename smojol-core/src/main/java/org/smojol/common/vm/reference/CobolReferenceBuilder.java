...
public class CobolReferenceBuilder {
  ...
  public CobolReference getReference(
      CobolParser.GeneralIdentifierContext to, CobolDataStructure data) {
  ...
  private static int resolve(
      CobolDataStructure data, CobolParser.ArithmeticExpressionContext index) {
