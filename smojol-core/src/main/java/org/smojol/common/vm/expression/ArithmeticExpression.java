...
public class ArithmeticExpression {
  public static CobolExpression expression(
      BinaryMathOperations operation, CobolExpression lhs, CobolExpression rhs) {
  ...
  public static CobolExpression expression(
      UnaryMathOperations operation, CobolExpression expression) {
    return switch (operation) {
