...
public class NullCobolExpression extends CobolExpression {
  private static final java.util.logging.Logger LOGGER =
      Logger.getLogger(NullCobolExpression.class.getName());
  ...
  @Override
  public CobolExpression lessThanOrEqualTo(
      CobolExpression other, CobolDataStructure dataStructures) {
    return new PrimitiveCobolExpression(TypedRecord.FALSE);
  }

  @Override
  public CobolExpression greaterThanOrEqualTo(
      CobolExpression other, CobolDataStructure dataStructures) {
    return new PrimitiveCobolExpression(TypedRecord.FALSE);
  }
  ...
  public double evalAsNumber(CobolDataStructure data) {
    return withWarning2(
        Double.NaN,
        "WARNING: Evaluating null cobol expression as Number, will return NaN",
        referenceID);
  }
  ...
  public boolean evalAsBoolean(CobolDataStructure data) {
    return withWarning2(
        false,
        "WARNING: Evaluating null cobol expression as Boolean, will return FALSE",
        referenceID);
  }
  ...
  public String evalAsString(CobolDataStructure data) {
    return withWarning2(
        EMPTY_STRING,
        "WARNING: Evaluating null cobol expression as String, will return '[NULL]'",
        referenceID);
  }
  ...
  public String toString() {
    return withWarning2(
        EMPTY_STRING,
        "WARNING: Evaluating null cobol expression as toString(), will return '[NULL]'",
        referenceID);
  }
  ...
  public CobolExpression add(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: Add Operation requested on null cobol expression", referenceID);
  }

  @Override
  public CobolExpression and(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: AND Operation requested on null cobol expression", referenceID);
  }

  @Override
  public CobolExpression or(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: OR Operation requested on null cobol expression", referenceID);
  }

  @Override
  public CobolExpression subtract(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: Subtract Operation requested on null cobol expression", referenceID);
  }

  @Override
  public CobolExpression divide(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: Divide Operation requested on null cobol expression", referenceID);
  }

  @Override
  public CobolExpression multiply(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: Multiply Operation requested on null cobol expression", referenceID);
  }

  @Override
  protected CobolExpression exponent(CobolExpression other, CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: Exponentiation Operation requested on null cobol expression", referenceID);
  }

  @Override
  protected CobolExpression negative(CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: Negation Operation requested on null cobol expression", referenceID);
  }

  @Override
  protected CobolExpression not(CobolDataStructure dataStructures) {
    return withWarning2(
        this, "WARNING: NOT Operation requested on null cobol expression", referenceID);
  }
