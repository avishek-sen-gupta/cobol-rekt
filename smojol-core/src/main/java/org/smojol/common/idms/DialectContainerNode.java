...
/**
 * This serves as a container for all IDMS-related code fragments which are then re-inserted back
 * into the parse tree on writing as JSON
 */
public class DialectContainerNode extends ParserRuleContext {
  ...
  public DialectContainerNode(
      ParseTree dialectNode,
      CobolParser.DialectNodeFillerContext parent,
      LocalisedDialect dialect) {
    super(parent, 1);
